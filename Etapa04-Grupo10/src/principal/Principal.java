 ...
 * 
 *  		"Etapa 4: Release 2 (07/06): Apresentar uma nova release do software considerando modificações e refinamentos discutidos na orientação
 *   com o professor. Apresentar a integração dos módulos de software que compõem o sistema. Grande parte das funcionalidades do sistema devem ter 
 *   sido implementadas."
 *  
 ...
 * 		O sistema eh formado por diferenes hierarquias de generalizacao, que descrevem comportamentos específicos e gerais de componentes do estacionamento,
 ...
 * a seleção de um carro de AndarAluguel disponivel para aluguel sob demanda. Os dados dos clientes também são guardados no gerenciadores propios
