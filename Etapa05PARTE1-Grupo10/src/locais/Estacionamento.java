...
public class Estacionamento {
	...
	private Estacionamento(int linhas, int colunas, double[] precosGaragem, double diariaAluguel, double precoSeguro,
	 ...
	 * return: boolean 
	 */
	public boolean desestacionarCarro (String placa) { 
	 ...
	 * return: boolean 
	 */
	public boolean desestacionarCarro (long CPF) { 
...
//		impresso.imprimirCliente(); //impresaao de cliente de aluguel
	 ...
	 * return: boolean
	 */
	public boolean devolverCarro(int IDAlugado) { 
